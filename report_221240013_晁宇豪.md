...
#### 修复3：fuzzTest中引发的对于输入的安全性修改

引入了安全的类型转化，主要是使用了一系列安全的类型转化函数。

![1734618275586](image/report_221240013_晁宇豪/1734618275586.png)

引入了对于输入的限制。

![1734618332392](image/report_221240013_晁宇豪/1734618332392.png)
